...
class RaceTextStyles {
  static TextStyle heading = TextStyle(fontSize: 32, fontWeight: FontWeight.w500);

  static TextStyle title =  TextStyle(fontSize: 24, fontWeight: FontWeight.w400);

  static TextStyle subtitle =  TextStyle(fontSize: 20, fontWeight: FontWeight.w400);

  static TextStyle body =  TextStyle(fontSize: 16, fontWeight: FontWeight.w500);

  static TextStyle subbody =  TextStyle(fontSize: 14, fontWeight: FontWeight.w400);
